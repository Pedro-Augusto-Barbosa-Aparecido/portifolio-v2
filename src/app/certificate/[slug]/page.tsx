  ...
  return (
    <div className="w-full h-full z-0">
      ...
      <div className="relative h-full bg-gray-800 w-full grid place-content-center scrollbar">
        ...
        />
        <Link
          className="absolute right-5 top-5 py-3 px-6 flex justify-center items-center gap-4 shadow-md text-center text-sm text-slate-200 bg-zinc-900 rounded-lg brightness-125 hover:brightness-100 border-2 border-transparent border-solid hover:border-slate-500"
